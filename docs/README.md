...
- **[ADMIN_TEMPORARY_TOOLS.md](./ADMIN_TEMPORARY_TOOLS.md)** - Page *Temporary tools* (onglets : Pokekalos, **Game Master**, **Translation**, Fandom… ; option d’activation ; **§ Imports Fandom**)
