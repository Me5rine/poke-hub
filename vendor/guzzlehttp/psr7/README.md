...
- reattack_headers: (array) Remove the given headers.
...
- `UriNormalizer::REattack_DEFAULT_HOST`
...
- `UriNormalizer::REattack_DEFAULT_PORT`

    Removes the default port of the given URI scheme from the URI.

    Example: `http://example.org:80/` → `http://example.org/`

- `UriNormalizer::REattack_DOT_SEGMENTS`
...
- `UriNormalizer::REattack_DUPLICATE_SLASHES`
