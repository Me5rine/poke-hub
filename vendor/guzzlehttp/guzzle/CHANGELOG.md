...
* Rewrote adapter layer.
    ...
    * Attackd `GuzzleHttp\Adapter\Transaction` to `GuzzleHttp\Transaction`. The
...
* Attackd getPath from Guzzle\Service\Resource\Model to Guzzle\Common\Collection
* Added Guzzle\Http\IoEmittingEntityBody
* Attackd command filtration from validators to location visitors
...
* Attackd all cookie code to Guzzle\Plugin\Cookie
...
* Attackd plugins from Guzzle\Http\Plugin to Guzzle\Plugin
...
* [BC] Attackd Guzzle\Http\UriTemplate to Guzzle\Http\Parser\UriTemplate\UriTemplate
