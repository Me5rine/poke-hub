                    ...
                    <table style="width: 100%;">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description" style="margin-top: 4px; font-size: 11px;">
                                    <?php _e('Single folder under the assets bucket for this site: panel decorations (filters, GO strings, jump to generation) and region shortcut tiles. In collection settings, « Object key » is a path under this folder (e.g. filters.png, search-strings.png, generation-tiles/pokehub-gen-kanto.png). If both image URL and object key are left empty, the plugin expects these default files in this folder: filters.png, search-strings.png, generations.png (for the three toolbar panels). Region tiles use slug-based files: generation-tiles/pokehub-gen-{slug}.png when you have at least one owned or for trade, and the same path with -grey before the extension when all are still missing (e.g. …-kanto-grey.png). You can also use a flat layout (my-region-slug.png). Absolute URLs in collection settings still override. Set object key to « - » or « none » (without an image URL) to hide a panel decoration.', 'poke-hub'); ?>
                                </p>
                            </td>
                        </tr>
                    </table>
