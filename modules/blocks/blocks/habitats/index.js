/**
 * Enregistrement côté client du bloc "Habitats"
 */
(function() {
    'use strict';
    ...
    registerBlockType('pokehub/habitats', {
        edit: function(props) {
                ...
                inspectorControls = el(
                    ...
                    el(
                        ...
                        el(ToggleControl, {
                            ...
                            help: __('Automatically retrieves habitats from the event', 'poke-hub')
                        })
                    )
                );
            }
            ...
            return el(
                ...
                blockProps,
                inspectorControls,
                el('p', {}, __('Habitats', 'poke-hub')),
                el('small', {}, __('This block automatically displays habitats from the event.', 'poke-hub'))
            );
        },
        save: function() {
            return null;
