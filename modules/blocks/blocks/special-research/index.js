/**
 * Enregistrement côté client du bloc "Études Spéciales"
 * 
...
(function() {
    ...
    registerBlockType('pokehub/special-research', {
        edit: function() {
            ...
            return el(
                'div',
                props,
                el('p', {}, __('Special Research', 'poke-hub')),
                el('small', {}, __('This block automatically displays special research from the event.', 'poke-hub'))
            );
        },
        save: function() {
