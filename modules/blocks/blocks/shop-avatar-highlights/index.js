(function () {
    ...
    registerBlockType('pokehub/shop-avatar-highlights', {
        edit: function (props) {
                ...
                inspectorControls = el(
                    ...
                    el(
                        ...
                        el(ToggleControl, {
                            ...
                            help: __(
                                'Uses the Avatar shop metabox on this post (hero image + items).',
                                'poke-hub'
                            )
                        })
                    )
            ...
            return el(
                ...
                blockProps,
                inspectorControls,
                el('p', {}, __('Avatar shop highlights', 'poke-hub')),
                el(
                    'small',
                    {},
                    __(
                        'Displays the hero image and shop items configured in the post metabox.',
                        'poke-hub'
                    )
                )
            );
