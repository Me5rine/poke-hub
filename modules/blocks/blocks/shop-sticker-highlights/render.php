...
$wrapper_attributes = get_block_wrapper_attributes([
    'class' => 'pokehub-shop-sticker-highlights-block pokehub-shop-highlights',
]);
        ...
        <div class="pokehub-shop-highlights-panel">
            ...
            <?php if ($has_items) : ?>
                <div class="pokehub-shop-highlights-panel__tiles">
                    <h3 class="pokehub-shop-highlights-panel__tiles-title"><?php esc_html_e('Stickers in this event', 'poke-hub'); ?></h3>
