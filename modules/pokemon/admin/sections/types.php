...
class Poke_Hub_Pokemon_Types_List_Table extends WP_List_Table {
    ...
    public function column_name($item) {
        ...
        // URL de la page publique du type
        $view_url = '';
        if (!empty($item->slug) && function_exists('pokehub_get_type_url')) {
            $view_url = pokehub_get_type_url($item->slug);
        }
    ...
    public function column_default($item, $column_name) {
        switch ($column_name) {
            ...
            case 'icon':
                ...
                if ($slug !== '' && function_exists('poke_hub_get_type_icon_url') && function_exists('pokehub_render_pokemon_type_icon_html')) {
                    $icon_url = poke_hub_get_type_icon_url($slug);
                    if ($icon_url !== '') {
